...
import (
	...
	getuser "github.com/qiniu/go-sdk/v7/iam/apis/get_user"
...
type innerGetUserRequest getuser.Request

func (path *innerGetUserRequest) buildPath() ([]string, error) {
...
type (
	GetUserRequest  = getuser.Request
...
func (iam *Iam) GetUser(ctx context.Context, request *GetUserRequest, options *Options) (*GetUserResponse, error) {
	...
	innerRequest := (*innerGetUserRequest)(request)
	...
	var rawQuery string
	headers := http.Header{}
	uplogInterceptor, err := uplog.NewRequestUplog("getUser", "", "", func() (string, error) {
