...
type innerGetUserPoliciesRequest getuserpolicies.Request

func (path *innerGetUserPoliciesRequest) buildPath() ([]string, error) {
...
func (query *innerGetUserPoliciesRequest) buildQuery() (url.Values, error) {
...
type (
	GetUserPoliciesRequest  = getuserpolicies.Request
	GetUserPoliciesResponse = getuserpolicies.Response
)
...
func (iam *Iam) GetUserPolicies(ctx context.Context, request *GetUserPoliciesRequest, options *Options) (*GetUserPoliciesResponse, error) {
	...
	innerRequest := (*innerGetUserPoliciesRequest)(request)
