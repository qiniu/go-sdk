...
func (path *innerUpdateGroupUsersRequest) buildPath() ([]string, error) {
...
func (iam *Iam) UpdateGroupUsers(ctx context.Context, request *UpdateGroupUsersRequest, options *Options) (*UpdateGroupUsersResponse, error) {
	...
	innerRequest := (*innerUpdateGroupUsersRequest)(request)
	...
	uplogInterceptor, err := uplog.NewRequestUplog("updateGroupUsers", "", "", func() (string, error) {
	...
	return &UpdateGroupUsersResponse{}, resp.Body.Close()
}
