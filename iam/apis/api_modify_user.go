...
func (path *innerModifyUserRequest) buildPath() ([]string, error) {
...
func (iam *Iam) ModifyUser(ctx context.Context, request *ModifyUserRequest, options *Options) (*ModifyUserResponse, error) {
	...
	innerRequest := (*innerModifyUserRequest)(request)
	...
	uplogInterceptor, err := uplog.NewRequestUplog("modifyUser", "", "", func() (string, error) {
	...
	var respBody ModifyUserResponse
