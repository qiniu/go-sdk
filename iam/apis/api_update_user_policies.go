...
func (path *innerUpdateUserPoliciesRequest) buildPath() ([]string, error) {
...
func (iam *Iam) UpdateUserPolicies(ctx context.Context, request *UpdateUserPoliciesRequest, options *Options) (*UpdateUserPoliciesResponse, error) {
	...
	innerRequest := (*innerUpdateUserPoliciesRequest)(request)
	...
	uplogInterceptor, err := uplog.NewRequestUplog("updateUserPolicies", "", "", func() (string, error) {
	...
	return &UpdateUserPoliciesResponse{}, resp.Body.Close()
}
