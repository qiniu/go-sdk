...
type (
	GetUserServiceActionResourcesRequest  = getuserserviceactionresources.Request
	GetUserServiceActionResourcesResponse = getuserserviceactionresources.Response
)
