...
func (client *Client) Send(ctx context.Context, request *Request) (*Response, error) {
	...
	req := httpclient.Request{Method: "DELETE", ServiceNames: serviceNames, Path: path, RawQuery: request.Query.build().Encode(), AuthType: auth.TokenQiniu, Credentials: request.Credentials}
