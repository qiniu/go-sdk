...
// 修改文件元信息
func (client *Client) ModifyObjectMetadata(ctx context.Context, request *ModifyObjectMetadataRequest, options *Options) (response *ModifyObjectMetadataResponse, err error) {
	if options == nil {
		options = &Options{}
	}
