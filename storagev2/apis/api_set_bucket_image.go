...
func (request *innerSetBucketImageRequest) getAccessKey(ctx context.Context) (string, error) {
...
func (storage *Storage) SetBucketImage(ctx context.Context, request *SetBucketImageRequest, options *Options) (*SetBucketImageResponse, error) {
	...
	uplogInterceptor, err := uplog.NewRequestUplog("setBucketImage", bucketName, objectName, func() (string, error) {
