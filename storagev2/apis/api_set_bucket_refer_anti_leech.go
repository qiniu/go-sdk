...
func (request *innerSetBucketReferAntiLeechRequest) getAccessKey(ctx context.Context) (string, error) {
...
func (storage *Storage) SetBucketReferAntiLeech(ctx context.Context, request *SetBucketReferAntiLeechRequest, options *Options) (*SetBucketReferAntiLeechResponse, error) {
	...
	uplogInterceptor, err := uplog.NewRequestUplog("setBucketReferAntiLeech", bucketName, objectName, func() (string, error) {
