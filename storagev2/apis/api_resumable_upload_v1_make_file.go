...
func (client *Client) ResumableUploadV1MakeFile(ctx context.Context, request *ResumableUploadV1MakeFileRequest, options *Options) (response *ResumableUploadV1MakeFileResponse, err error) {
	if options == nil {
		options = &Options{}
	}
