...
func (client *Client) SetObjectFileType(ctx context.Context, request *SetObjectFileTypeRequest, options *Options) (response *SetObjectFileTypeResponse, err error) {
	if options == nil {
		options = &Options{}
	}
