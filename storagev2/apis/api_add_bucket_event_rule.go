...
func (request *innerAddBucketEventRuleRequest) getAccessKey(ctx context.Context) (string, error) {
...
func (storage *Storage) AddBucketEventRule(ctx context.Context, request *AddBucketEventRuleRequest, options *Options) (*AddBucketEventRuleResponse, error) {
	...
	uplogInterceptor, err := uplog.NewRequestUplog("addBucketEventRule", bucketName, objectName, func() (string, error) {
