...
// 更新文件生命周期
func (client *Client) DeleteObjectAfterDays(ctx context.Context, request *DeleteObjectAfterDaysRequest, options *Options) (response *DeleteObjectAfterDaysResponse, err error) {
	if options == nil {
		options = &Options{}
	}
