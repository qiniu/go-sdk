...
type RequestBody struct {
	...
	fieldName                   string // 规则名称空间内唯一，长度小于50，不能为空，只能为字母、数字、下划线
	fieldPrefix                 string // 匹配的对象名称前缀，同一个空间内前缀不能重复
...
// 规则名称空间内唯一，长度小于50，不能为空，只能为字母、数字、下划线
