...
// 1 表示开启原图保护，0 表示关闭原图保护
func (pp *RequestPath) GetMode() int64 {
	return pp.fieldMode
}

// 1 表示开启原图保护，0 表示关闭原图保护
func (pp *RequestPath) SetMode(value int64) *RequestPath {
	pp.fieldMode = value
	return pp
}
...
func (path *RequestPath) build() ([]string, error) {
	...
	allSegments = append(allSegments, "mode", strconv.FormatInt(path.fieldMode, 10))
...
// 1 表示开启原图保护，0 表示关闭原图保护
func (request *Request) GetMode() int64 {
	return request.path.GetMode()
}

// 1 表示开启原图保护，0 表示关闭原图保护
func (request *Request) SetMode(value int64) *Request {
	request.path.SetMode(value)
	return request
}
