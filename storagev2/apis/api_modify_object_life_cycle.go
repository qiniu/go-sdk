...
// 修改已上传对象的生命周期
func (client *Client) ModifyObjectLifeCycle(ctx context.Context, request *ModifyObjectLifeCycleRequest, options *Options) (response *ModifyObjectLifeCycleResponse, err error) {
	if options == nil {
		options = &Options{}
	}
